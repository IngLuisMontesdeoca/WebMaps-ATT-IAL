...
class amountCharging {
    ...
    function _chargeAmount($msisdn = '', $amount = '', $description = array(), $SC) {
        ...
        try {
            ...
            $body_part = '<loc:chargeAmount xmlns:loc="http://www.csapi.org/schema/parlayx/payment/amount_charging/v2_1/local">
                <loc:endUserIdentifier>tel:'.$msisdn.'</loc:endUserIdentifier>
                <loc:charge>
                   <description>'.$description.'</description>
                   <currency>MXN</currency>
                   <amount>'.$amount.'</amount>            
                </loc:charge>
                <loc:referenceCode>'.$SC.'</loc:referenceCode>
             </loc:chargeAmount>';
            $soapstruct = new SoapVar($body_part, XSD_ANYXML, null, null, null);
            $chargeAmountResponse = $this->client->chargeAmount($soapstruct);
