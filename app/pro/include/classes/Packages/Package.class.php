<?php
  ...
  {//<<---------------------------------------------------- Class Package
      ...
      * import()
      * @access         public static
      * @description    Permite importar Paquetes Específicos en el Sistema.
      * @params         String package->Nombre del Paquete a importar
      */
        ...
        {//<<------------------------------------------- import()
			...
			switch( $package ) {//<<---------------- Switch package
				...
				//---- Classes ----//
					...
					//Reportes
					case 'REPORTES':
						 self::_isSetPack('Classes', 'Reportes');
						 $newPath = PATH_SEPARATOR.ROOT_CLASS.'/Reportes';
					break;
     ...
     * _isSetPack() 
     * @access          private static
     * @description     Evalúa si se está utilizando el paquete General del cual depende
	 *					un paquete de importación
     ...
     * _setIncludePath() 
     * @access          private static
     * @description     Setea un path en las rutas de inicio del Script en ejecución
     * returns          boolean
     */
        ...
        {//<<------------------------------------------- _setIncludePath()       
            ...
            if( !preg_match("|".preg_quote($newPath)."|", $actualPath) ) {
